...
from custom_components.dhl.calendar import DHLDeliveriesCalendar
...
def _cal(data):
    return DHLDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="DHL Shop")])
    assert cal._events()[0].location == "DHL Shop"

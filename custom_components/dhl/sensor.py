"""Sensor platform for the DHL parcel tracker integration."""
...
class DHLIncomingParcelsSensor(
    ...
    def _handle_coordinator_update(self) -> None:
        ...
        if new_barcodes:
            self._async_add_entities(
                DHLParcelSensor(self.coordinator, self._entry, barcode)
...
class DHLParcelSensor(CoordinatorEntity[DHLCoordinator], SensorEntity):
    """Per-parcel sensor reporting the status of one tracked DHL parcel."""
    ...
    def __init__(
        self, coordinator: DHLCoordinator, entry: ConfigEntry, barcode: str
    ) -> None:
        """Initialize the sensor."""
        super().__init__(coordinator)
        self._entry = entry
...
class DHLDeliveredParcelsSensor(
    CoordinatorEntity[DHLCoordinator], SensorEntity
):
    """Recently delivered tracked DHL parcels."""
